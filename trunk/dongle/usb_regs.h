...
USB_REGISTER(uint8_t out5buf[USB_DEFAULT_EP_SIZE], 0xC440);
USB_REGISTER(uint8_t in5buf[USB_DEFAULT_EP_SIZE], 0xC480);
USB_REGISTER(uint8_t out4buf[USB_DEFAULT_EP_SIZE], 0xC4C0);
USB_REGISTER(uint8_t in4buf[USB_DEFAULT_EP_SIZE], 0xC500);
USB_REGISTER(uint8_t out3buf[USB_DEFAULT_EP_SIZE], 0xC540);
USB_REGISTER(uint8_t in3buf[USB_DEFAULT_EP_SIZE], 0xC580);
USB_REGISTER(uint8_t out2buf[USB_DEFAULT_EP_SIZE], 0xC5C0);
USB_REGISTER(uint8_t in2buf[USB_DEFAULT_EP_SIZE], 0xC600);
USB_REGISTER(uint8_t out1buf[USB_DEFAULT_EP_SIZE], 0xC640);
